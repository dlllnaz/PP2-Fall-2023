...
matches=re.findall(pattern, text)    
print(matches)
result = re.findall('a[b]{2,3}', text)
#3
pattern = r'[а-я]+_[а-я]+'
matches = re.findall(pattern,text)
print(matches)
result = re.findall('[а-я]+_[а-я]+', text)
#4
pattern = r'[А-Я]+[а-я]+'
matches = re.findall(pattern,text)
print(matches)
...
test = "Оператор_фискальных_данных:_АОКазахтелеком"
result = snake_to_camel(test)
print(result)
#8
text = "ОператорФискальныхДанных"
print(re.findall('[А-Я][^А-Я]*', text))
